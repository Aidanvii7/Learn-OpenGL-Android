...
import com.aidanvii.utils.Action
...
fun Any.logW(message: String) = logW(javaClass.simpleName, message)
fun Any.logV(message: String) = logV(javaClass.simpleName, message)
